...
set d=${main}/src/sample-data/situation2

set a=train:${d}/situation2-train-a.xml 
set b=train:${d}/situation2-train-b.xml 
set atest=test:${d}/situation2-train-a.xml:${out}/sample-situation2-scores-a-eg.txt 
set btest=test:${d}/situation2-train-b.xml:${out}/sample-situation2-scores-b-eg.txt 
set c=test:${d}/situation2-test.xml:${out}/sample-situation2-scores-c-eg.txt 
